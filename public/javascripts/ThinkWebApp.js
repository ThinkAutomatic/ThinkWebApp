...
(function() {
  $(document).on('pagecreate', function() {
    var actionTypes, addNumProp, addProp, alertDialog, camelCaseToSpaced, checkMode, confirmDialog, convertToLocalTime, currentActionType, deviceType, deviceTypeStep, dtSearchTextBlur, editObject, errorCheck, eventCommandName, exitFullscreen, fixedEncodeURI, getCookie, getDeviceTypeInfo, getInstructionsPopup, getNamePopup, gotoPrevStep, gotoStep, handleDeviceTypeWizardStep, handleStep, handleYesNo, isValid, launchFullscreen, loadDeviceTypeWithChanges, modeName, modeNames, modes, newAttrName, padNum, registerDeviceType, saveAsDraft, selectModesPopup, sendPhraseCommand, sendSlideEvents, setTitlePrompt, singleActionAdd, submitKey, timeZone, trimTrailingChars, updateDtSearch, urlToThinkAutomatic, yesNoAnswer, yesNoPopup;
    ...
    $('.assocDevicePopup').click(function(event) {
      var roomIdSelected;
      ...
      return $('#assocDevicePopupDialog').popup('open');
    });
    $('#assocDeviceSubmit').click(function(event) {
      var linkPath, roomIdSelected;
    ...
    $('#linkDeviceSubmit').click(function(event) {
      var linkMessage, linkPath, postData, roomIdSelected;
      postData = {};
      linkPath = '';
      linkMessage = '';
      $.mobile.loading('show');
    ...
    $('#linkDeviceName').click(function(event) {
      ...
      $('#linkDevicePopupDialog').popup('close');
      return setTimeout((function() {
        return editObject('Device Name', null, 'Name for new device(s)', 'true');
      }), 100);
    });
    ...
    $('#devicePopupDialog').on('popupafterclose', function() {
      if ($('#devicePopupDialog').attr('data-reload') === 'true') {
        $.mobile.loading('show');
        return window.location.reload();
      }
    });
    ...
    return $('#deleteDeviceTypeSubmit').click(function() {
      return getDeviceTypeInfo(function() {
        var prompt;
