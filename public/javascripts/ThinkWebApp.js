  ...
  <a href="#" class="ui-btn ui-btn-inline ui-btn-raised buttonPlus"><i class="zmdi zmdi-plus zmd-2x"></i></a>
    ...
    gotoHelpStep = function(step) {
      ...
      switch (helpStep) {
        ...
        case 30:
          return yesNoHelpPopup('Pair Luminode', 'Is this first Luminode you are attempting to pair with or do you already have one or more already working?', 'First One', 'Others working');
        case 40:
          return yesNoHelpPopup('Pair Luminode', 'Tap the Luminode to turn it either on or off. Did the indicator on the front of it turn a solid red color?');
        case 50:
          return yesNoHelpPopup('Pair Luminode', 'Using your mobile device try connecting to an open WiFi network named "ThinkAutoNew-(some id number)". After you connect to that network your mobile device should be automatically redirected to a WiFi setup process. Have you already tried this an ran into an issue?');
        case 60:
        ...
        case 70:
          return yesNoHelpPopup('Pair Luminode', 'If you have not already tried this, tell your mobile device to "forget" the ThinkAutoNew- network (exact process varies depending on your mobile device). Then attempt to reconnect to the same network again. Have you already tried this and want to try something else?');
        case 80:
          return yesNoHelpPopup('Pair Luminode', 'If you have not already tried this, press both the up/on button and the down/off button on the Luminode at the same time, which may require a slightly firm press, then release. This will cause the Luminode to restart itself. After a few seconds press one of the buttons on the Luminode to turn the indicator red again. Then attempt to connect to the ThinkAutoNew- network again. Have you already tried this and want to try something else?');
        case 90:
          return yesNoHelpPopup('Pair Luminode', 'Did the indicator turn cyan (light blue)?');
        case 100:
          return yesNoHelpPopup('Pair Luminode', 'This may mean that your Luminode is attempting to connect to a Luminode network belonging to a neighbor. Try tapping your Luminode again until the indicator turns red. Has the indicator turned red?');
        case 120:
        ...
        case 200:
          return yesNoHelpPopup('Pair Luminode', 'Tap the Luminode you are attempting to pair to turn it either on or off. Did the indicator on the front of it turn cyan (light blue)?');
        case 210:
